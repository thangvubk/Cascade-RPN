...
data = dict(
    ...
    train=dict(
        ...
        proposal_file=data_root + 'proposals/cascade_rpn_r50_fpn_1x_train2017.pkl',  # noqa: E501
        flip_ratio=0.5,
        with_mask=False,
        with_crowd=True,
        with_label=True),
    val=dict(
        ...
        size_divisor=32,
        num_max_proposals=300,
        proposal_file=data_root + 'proposals/cascade_rpn_r50_fpn_1x_val2017.pkl',  # noqa: E501
        flip_ratio=0,
        with_mask=False,
        with_crowd=True,
        with_label=True),
